    ...
    <head>
        ...
        <script>
                 function addHomePage() {
                    var d = document.getElementById("mainRightContainerBottom").innerHTML = '<object type="text/html" data="Student_page_home.php" style="width: 100%; height: 100%; "></object>'; 
                }
                function addProfilePage() {
                    var d = document.getElementById("mainRightContainerBottom").innerHTML = '<object type="text/html" data="Student_page_profile.php" style="width: 100%; height: 100%; "></object>'; 
                }
                
              
                function addAttendanceReportPage() {
                    var d = document.getElementById("mainRightContainerBottom").innerHTML = '<object type="text/html" data="Student_page_attendance_report.php" style="width: 100%; height: 100%; "></object>'; 
                }
                function addPasswordPage() {
                    var d = document.getElementById("mainRightContainerBottom").innerHTML = '<object type="text/html" data="Student_page_password.php" style="width: 100%; height: 100%; "></object>'; 
                }
                

        </script>
    </head>
    <body onload="addHomePage()">
        <div id="main">
            <div id="mainLeftContainer">
                <div id="mainLeftContainerTop">
                    <div id="mainLeftContainerE-1">
                        ...
                        <div id="table-image">
                            <img src="<?php echo Session::get('student_photo');?>" alt="User Photo">
                        </div>

                        <span id="mainLeftContainerE-1-name">Name: <?php echo Session::get('student_name');?></span>
                        <span id="mainLeftContainerE-1-username">Username: <?php echo Session::get('student_username');?></span>
                    </div>
                </div>
                <div id="mainLeftContainerBottom">
                    <a href="#" onclick="addHomePage()">
